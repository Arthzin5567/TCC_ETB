<?php
    ...
    $sql_deleta = "DELETE FROM auxiliardedentista
                    WHERE cpf = '$cod'";
    ...
    if ($sql_resultado_delecao = true) {
        ...
        echo "<script> alert ('Auxiliar deletado com sucesso! ') </script>";
        ...
        echo "<script> location.href ('lista_auxden.php?codigo=$cod') </script>";
