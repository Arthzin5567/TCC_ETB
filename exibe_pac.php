    ...
    <body>
        <div id="principal">
            ...
            <div id="conteudo_especifico">
                ...
                $stmt = mysqli_prepare($conectar, "SELECT dataCadastro, nome, cpf, endereco, dataNascimento, telefone
                                FROM paciente
                                WHERE cpf = '$cod'");
                ...
                echo "<p> Data de Cadastro: " . htmlspecialchars($registro['dataCadastro']) . "</p>";
